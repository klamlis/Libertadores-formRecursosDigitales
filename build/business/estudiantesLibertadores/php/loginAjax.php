<?php
	...
	switch ($data_index) 
	{
    	case 0:
			...
			$campoUno = "SELECT expresionEscrita FROM refuerzo_academico WHERE documento='$data_Documento'";
			...
			{
	    		// imprimir la fecha
				$imprimirFecha = "UPDATE refuerzo_academico SET expresionEscrita='$hoy' Where documento='$data_Documento'";
				mysql_query($imprimirFecha, $con);
			}
        	break;
    	case 1:
        	////Saber si el campo esta vacio
			$campoDos = "SELECT lectoEscritura FROM refuerzo_academico WHERE documento='$data_Documento'";
			...
			{
	    		// imprimir la fecha
				$imprimirFecha = "UPDATE refuerzo_academico SET lectoEscritura='$hoy' Where documento='$data_Documento'";
				mysql_query($imprimirFecha, $con);
			}
        	break;
        ...
        case 2:
        	////Saber si el campo esta vacio
			$campoTres = "SELECT matematica FROM refuerzo_academico WHERE documento='$data_Documento'";
			...
			{
	    		// imprimir la fecha
				$imprimirFecha = "UPDATE refuerzo_academico SET matematica='$hoy' Where documento='$data_Documento'";
				mysql_query($imprimirFecha, $con);
			}
        	break;
        case 3:
        	////Saber si el campo esta vacio
			$campoCuatro = "SELECT orientacionVocacional FROM refuerzo_academico WHERE documento='$data_Documento'";
			...
			{
	    		// imprimir la fecha
				$imprimirFecha = "UPDATE refuerzo_academico SET orientacionVocacional='$hoy' Where documento='$data_Documento'";
				mysql_query($imprimirFecha, $con);
			}
        	break;
        case 4:
        	////Saber si el campo esta vacio
			$campoCinco = "SELECT redaccionBasica FROM refuerzo_academico WHERE documento='$data_Documento'";
			...
			{
	    		// imprimir la fecha
				$imprimirFecha = "UPDATE refuerzo_academico SET redaccionBasica='$hoy' Where documento='$data_Documento'";
				mysql_query($imprimirFecha, $con);
			}
        	break;
        case 5:
        	////Saber si el campo esta vacio
			$campoSeis = "SELECT tecnologiaEducativa FROM refuerzo_academico WHERE documento='$data_Documento'";
			...
			{
	    		// imprimir la fecha
				$imprimirFecha = "UPDATE refuerzo_academico SET tecnologiaEducativa='$hoy' Where documento='$data_Documento'";
				mysql_query($imprimirFecha, $con);
			}
        	break;
	}
